    ...
    .then((data) => {
      ...
      userData.forEach((element) => {
        ...
        modalContainer.innerHTML = `
              ...
              <div id="modal2-div2">
                  <h2>Content</h2>
                  <textarea id="editMessageTextArea" rows="5" cols="50" placeholder="example sentences, Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex similique nihil laudantium, quod ea cupiditate">${messageTextArea}</textarea>
              </div>
              <div id="modal2-div3">
        ...
        modalContainer.querySelector("#modal2Send").onclick = function () {
          let editDropdown1 = document.getElementById("editDropdown1").value;
          let editDropdown2 = document.getElementById("editDropdown2").value;
          let editMessageTextArea = document.getElementById(
            "editMessageTextArea"
          ).value;
